...
export async function POST(request: Request) {
  try {
    ...
    const { title, company, start_date, end_date, is_current, description, display_order } = body
...
export async function PATCH(request: Request) {
  try {
    ...
    const { id, title, company, start_date, end_date, is_current, description, display_order } = body
